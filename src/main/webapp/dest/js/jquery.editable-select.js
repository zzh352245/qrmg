...
(function($) {
  ...
  EditableSelect.prototype = {
    ...
    init: function(select, settings) {
      ...
      //$(".editable-select").css({"background":"#FFF url(../../css/images/arrow-down.png) 134px center no-repeat","font":"12px/1.5 'Microsoft Yahei',tahoma,arial,'Hiragino Sans GB',宋体;"});
      $(".editable-select").attr("style","background:#FFF url(../../css/images/arrow-down.png) 134px center no-repeat;font:12px/1.5 'Microsoft Yahei',tahoma,arial,'Hiragino Sans GB',宋体;");
    ...
    initInputEvents: function(text) {
      ...
      text.blur(
	        function(e) {
	         ...
	         /* if(val==''){
	        	  $("#province_id_sele").val('请选择');
	        	  $("#province_id2_sele").val('请选择');
	          }*/
      ...
      text.focus(
        function(e) {
    //    $("#province_id_sele").val('');
       /* $("#province_id2_sele").val('');*/
    ...
    showList: function() {
      ...
      this.setWidths();
      this.wrapper.show();
      $("#province_id_editable-select-options ul li").css("display","block");
      $("#province_id2_editable-select-options ul li").css("display","block");
    //  $(".editable-select").val('');
      this.hideOtherLists();
    ...
    setWidths: function() {
      ...
      this.select.show();
      var width = this.select.width()-20;
      this.select.hide();
